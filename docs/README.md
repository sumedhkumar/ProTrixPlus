...
- [CLIENT-ONBOARDING-ARCHITECTURE.md](CLIENT-ONBOARDING-ARCHITECTURE.md) — system architecture diagram + real new-client onboarding flow, for sharing with the team.
