...
@router.get("/strategies/unmapped-signals", dependencies=[_STRATEGY_READ])
...
@router.post("/strategies/{strategy_id}/archive", dependencies=[_STRATEGY])
...
@router.post("/strategies/{strategy_id}/unarchive", dependencies=[_STRATEGY])
...
@router.post("/assignments/{assignment_id}/approve", dependencies=[_FINANCE])
